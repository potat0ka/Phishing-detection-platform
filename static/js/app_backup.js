...
async function handleQuickAnalysis(event) {
    ...
    const content = formData.get('input_content'); // Homepage uses 'input_content'
...
function displayAnalysisResult(result) {
    ...
    const content = data.content || 'Unknown content';
    ...
    resultContainer.innerHTML = `
        <div class="card border-0 shadow">
            <div class="card-header bg-gradient-${alertClass} text-white">
                <h5 class="mb-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="confidence-meter text-center">
                            <canvas id="confidenceChart" width="120" height="120"></canvas>
    ...
    createConfidenceChart(confidence, alertClass);
}

/**
 * Create confidence visualization chart
 */
function createConfidenceChart(confidence, alertClass) {
    ...
    ctx.fillText(`${confidence}%`, canvas.width/2, canvas.height/2 + 5);
}
...
/**
 * Content type switching and demo setup functions
 */
function initializeContentTypeSwitcher() {
    // Basic placeholder update functionality
