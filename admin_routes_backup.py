...
def delete_user(user_id):
    ...
    try:
        ...
        # Get decrypted username for logging
        ...
        detections_deleted = db_manager.delete_many('detections', {'user_id': user_id})
        
        # Delete any reports by this user
        reports_deleted = db_manager.delete_many('reports', {'user_id': user_id})
        
        # Delete admin actions by this user (if they were admin)
        admin_actions_deleted = db_manager.delete_many('admin_actions', {'admin_id': user_id})
